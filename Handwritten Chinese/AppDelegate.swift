...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func splashScreen(){
        ...
        Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(dissmissSplashController), userInfo: nil, repeats: false)
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Handwritten_Chinese")
