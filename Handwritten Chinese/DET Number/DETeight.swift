...
class DETeight: UIView {
    ...
    var c1 = CGRect(x: 20,y: 145,width: 135,height: 50)
    var cl1 = CGRect(x: 20,y: 195,width: 135,height: 105)
    
    var c2 = CGRect(x: 160,y: 60,width: 210,height: 50)
    var cl2 = CGRect(x: 160,y: 110,width: 210,height: 175)
    ...
    override func layoutSubviews() {
        ...
        backgroundImage.image = UIImage(named: "8view")
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if paths.count == 2 {
            ...
            if  (c1.contains(firstPoints[0]) && (c1.contains(linePoints1[middle0]) || cl1.contains(linePoints1[middle0])) && (c1.contains(linePoints1[middle1]) || cl1.contains(linePoints1[middle1])) && (c1.contains(linePoints1[middle2]) || cl1.contains(linePoints1[middle2])) && cl1.contains(lastPoints[0]))                                                                                                           && (c2.contains(firstPoints[1]) && (cl2.contains(linePoints2[middle5]) && cl2.contains(linePoints2[middle6]) && cl2.contains(linePoints2[middle7]) && cl2.contains(linePoints2[middle8]) && cl2.contains(linePoints2[middle9])) && cl2.contains(lastPoints[1])){
